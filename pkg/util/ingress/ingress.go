...
// TODO: The funcs above are duplicated with internal/ingress and should be removed as a next cleanup step
// GetRemovedHosts returns a list of the hostnames that are not associated anymore to the NGINX configuration.
